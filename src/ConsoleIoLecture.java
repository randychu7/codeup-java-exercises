...
//            System.out.println(myName);
            ...
            // ================================== IMPORTS
//            Scanner sc = new Scanner(System.in); //Represents a way for the scanner to listen to user input
//
//            System.out.println("Enter your Age: ");
//
//            String userAge = sc.nextLine();  // Scanner allows you to put an input in the next line, give back the output that only returns a string.
//
//
//
//            System.out.println(userAge + 10);
...
//            System.out.println(what);
            ...
            // .nextInt() captures the first valid int value, no longer needs to parse float a number:
